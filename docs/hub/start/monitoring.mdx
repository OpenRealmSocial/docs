...
title: 'Monitoring'
description:
  'Hub ships with a default Grafana configuration to monitor sync and perf.'
---
...
If you are running hub from source, you can pass this in as a command line argument
```bash
